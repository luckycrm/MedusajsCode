...
import { DEFAULT_SERVER_SETTINGS } from "@mctools/contracts";
import {
  type ClientSettings,
...
const CLIENT_SETTINGS_STORAGE_KEY = "medusajscode:client-settings:v1";
const OLD_SETTINGS_KEY = "medusajscode:app-settings:v1";
