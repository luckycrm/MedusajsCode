...
import { resolveModelSlugForProvider } from "@mctools/shared/model";
...
const PERSISTED_STATE_KEY = "medusajscode:renderer-state:v1";
const LEGACY_PERSISTED_STATE_KEYS = [
  "mccode:renderer-state:v7",
  "mccode:renderer-state:v6",
  "mccode:renderer-state:v5",
  "mccode:renderer-state:v4",
  "mccode:renderer-state:v3",
