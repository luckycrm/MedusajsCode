...
import { decodeJsonResult, formatSchemaError } from "@mctools/shared/schemaJson";
 ...
 */
export class Server extends ServiceMap.Service<Server, ServerShape>()("mc/wsServer/Server") {}
