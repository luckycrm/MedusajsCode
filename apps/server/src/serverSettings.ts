...
import { type DeepPartial, deepMerge } from "@mctools/shared/Struct";
import { fromLenientJson } from "@mctools/shared/schemaJson";
...
export class ServerSettingsService extends ServiceMap.Service<
  ...
  ServerSettingsShape
>()("mc/serverSettings/ServerSettingsService") {
