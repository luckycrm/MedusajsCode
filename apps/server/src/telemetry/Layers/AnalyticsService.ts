...
const TelemetryEnvConfig = Config.all({
  posthogKey: Config.string("MCCODE_POSTHOG_KEY").pipe(
    Config.withDefault("phc_XOWci4oZP4VvLiEyrFqkFjP4CZn55mjYYBMREK5Wd6m"),
  ),
  posthogHost: Config.string("MCCODE_POSTHOG_HOST").pipe(
  ...
  maxBufferedEvents: Config.number("MCCODE_TELEMETRY_MAX_BUFFERED_EVENTS").pipe(
