...
import { CodexModelSelection } from "@mctools/contracts";
import { sanitizeBranchFragment, sanitizeFeatureBranchName } from "@mctools/shared/git";
...
const makeCodexTextGeneration = Effect.gen(function* () {
  ...
  const writeTempFile = (
    ...
    return fileSystem
      .makeTempFileScoped({
        prefix: `medusajscode-${prefix}-${process.pid}-${randomUUID()}.tmp`,
      })
      .pipe(
